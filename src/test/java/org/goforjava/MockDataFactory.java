...
public class MockDataFactory {
    ...
    public void populateDepartments() {
        departmentDB.put(new Id("d1"), new Department(new Id("d1"), "Ministerstwo Magii"));
        departmentDB.put(new Id("d2"), new Department(new Id("d2"), "Departament Tajemnic"));
        departmentDB.put(new Id("d3"), new Department(new Id("d3"), "Departament Kontroli Nad Magicznymi Stworzeniami"));
        departmentDB.put(new Id("d4"), new Department(new Id("d4"), "Departament Przestrzegania Prawa Magicznego"));
        departmentDB.put(new Id("d5"), new Department(new Id("d5"), "Departament Międzynarodowej Współpracy w Magicznych Sprawach"));
        departmentDB.put(new Id("d6"), new Department(new Id("d6"), "Departament Mgieł i Dymów"));
    }
    ...
    public void populateEmployees() {
        ...
        employeeDB.put(new Id("e7"), new Employee(new Id("e7"), "Albus Dumbledore", LocalDate.of(1881, 8, 8), LocalDate.of(1950, 7, 31), 6000L, "Dyrektor Szkoły Magii", new Id("d7")));
        ...
        employeeDB.put(new Id("e9"), new Employee(new Id("e9"), "Rubeus Hagrid", LocalDate.of(1928, 12, 6), LocalDate.of(1947, 7, 31), 4600L, "Strażnik Klucza", new Id("d7")));
        employeeDB.put(new Id("e10"), new Employee(new Id("e10"), "Bellatrix Lestrange", LocalDate.of(1951, 9, 14), LocalDate.of(1970, 7, 31), 5200L, "Strażnik Azkabanu", new Id("d4")));
        ...
        employeeDB.put(new Id("e12"), new Employee(new Id("e12"), "Gilderoy Lockhart", LocalDate.of(1964, 1, 26), LocalDate.of(1993, 7, 31), 5500L, "Nauczyciel Obrony Przed Czarną Magią", new Id("d7")));
        ...
        employeeDB.put(new Id("e16"), new Employee(new Id("e16"), "Narcissa Malfoy", LocalDate.of(1955, 6, 5), LocalDate.of(1974, 7, 31), 5200L, "Członek Wysokiej Rady Czarodziejów", new Id("d1")));
        ...
        employeeDB.put(new Id("e20"), new Employee(new Id("e20"), "Cornelius Fudge", LocalDate.of(1935, 9, 8), LocalDate.of(1963, 7, 31), 5100L, "Minister Magii", new Id("d1")));
